...
public class AliexpressTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement search = driver.findElement(By.xpath("//*[@id=\"search-words\"]"));
        search.sendKeys(searchText);
        WebElement searchButton = driver.findElement(By.xpath("//*[@id=\"_global_header_23_\"]/div/div/div[2]/div[1]/div[1]/div/input[2]"));
        searchButton.click();
